...
跨平台（macOS／Windows）Electron 桌面寵物。內建 27 隻：橘貓/三花貓/柴犬/柯爾鴨/倉鼠/雪倉鼠 6 隻＋十二生肖 12 隻＋台灣特有種 9 隻（石虎/藍鵲/黑熊/獼猴用使用者 IP 畫稿當參考，其餘文字生成）；上傳一張圖可請 Gemini 生成 8 格動作表匯入。多螢幕：每個螢幕一個覆蓋視窗，寵物模擬在主程序跑全域座標。
