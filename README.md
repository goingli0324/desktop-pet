...
內建 27 隻：橘貓、三花貓、柴犬、柯爾鴨、倉鼠、雪倉鼠，加上十二生肖與九種台灣特有種（石虎、台灣藍鵲、台灣黑熊、台灣獼猴、帝雉、梅花鹿、山羌、台灣犬、穿山甲）；上傳一張自己的圖，就能請 Gemini 畫出 8 個動作、變成你的專屬小動物。macOS 與 Windows 都能用。

## 使用

1. 啟動後小動物會出現在桌面上，系統匣（mac 右上角／Windows 右下角）會多一個貓頭圖示。
2. 點圖示 → 「設定…」可以決定每種動物出現幾隻（例如 3 隻貓加 5 隻鴨，總數上限 99）、匯入新動物、調大小、暫停。小動物上按右鍵也有同樣的選單。
3. 匯入新動物：
